...
using context = basic_context<with_element<uint_fast32_t>>;
...
buffer_state image_buffer_state() noexcept
{
	auto b = buffer_state{};
...
buffer_state label_buffer_state() noexcept
{
	return buffer_state{};
}

class image_io_state : public array_state_base<image_io_state, uint_fast32_t>
{
	using reference =
...
class label_io_state : public array_state_base<label_io_state, uint_fast32_t>
{
